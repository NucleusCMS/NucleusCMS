 ...
 * @copyright Copyright (C) 2002-2011 The NucleusCMS Japan������
 * @version $Id$
 */
 ...
 *        Start New for 3.62                *
 ********************************************/
define('_SETTINGS_ADMINCSS',		'�����ΰ�Υ������륷����');
...
define('_ADMIN_SYSTEMOVERVIEW_LATESTVERSION_TITLE',		'�������С�����������ǽ���⤷��ޤ���');
define('_ADMIN_SYSTEMOVERVIEW_LATESTVERSION_TEXT',		'���åץ��졼�ɤ������ǽ���⤷��ޤ��� v');
...
// Errors
define('_ERRORS_INSTALLSQL',						'��install/install.sql���ե��������Ƥ�������');
define('_ERRORS_INSTALLDIR',						'��install���ǥ��쥯�ȥ����Ƥ�������');  // <add by shizuki />
define('_ERRORS_INSTALLPHP',						'��install/index.php���ե��������Ƥ�������');
...
// Language Files
define('_LANGUAGEFILES_JAPANESE-UTF8',				'���ܸ� - ���ܸ� (EUC-JP)');
define('_LANGUAGEFILES_JAPANESE-EUC',				'���ܸ� - ���ܸ� (EUC)');
define('_LANGUAGEFILES_JAPANESE-SJIS',				'���ܸ� - ���ܸ� (Shift-JIS)');
define('_LANGUAGEFILES_ENGLISH-UTF8',				'�Ѹ� - English (EUC-JP)');
...
define('_LANGUAGEFILES_CHINESE-UTF8',				'���λ����� - &#31777;&#20307;&#23383;&#20013;&#25991; (EUC-JP)');
define('_LANGUAGEFILES_CHINESEB5',					'���λ����� - &#32321;&#20307;&#23383;&#20013;&#25991; (big5)');
define('_LANGUAGEFILES_CHINESEB5-UTF8',				'���λ����� - &#32321;&#20307;&#23383;&#20013;&#25991; (EUC-JP)');
define('_LANGUAGEFILES_TRADITIONAL_CHINESE',		'���λ����� - &#32321;&#20307;&#23383;&#20013;&#25991; (big5)');
define('_LANGUAGEFILES_TRADITIONAL_CHINESE-EUC-JP',	'���λ����� - &#32321;&#20307;&#23383;&#20013;&#25991; (EUC-JP)');
...
define('_LANGUAGEFILES_SPANISH-UTF8',				'���ڥ���� - Espa&ntilde;ol (EUC-JP)');
