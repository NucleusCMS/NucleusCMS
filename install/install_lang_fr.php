...
define('_INSTALL_TEXT_CONFIG_WRITE_WARNING',           'config.php might not be created automatically (%s). Please adjust permissions before continuing.');
define('_INSTALL_TEXT_CONFIG_WRITE_REASON_FILE_PERMISSION', 'config.php is not writable.');
define('_INSTALL_TEXT_CONFIG_WRITE_REASON_FOLDER_PERMISSION', 'The Nucleus root folder is not writable.');
define('_INSTALL_TEXT_BLADE_CACHE_PERMISSION', 'Impossible de garantir l\'écriture dans le répertoire de cache BladeOne (%s). Merci d\'ajuster les permissions pour que l\'interface d\'administration puisse s\'afficher.');
