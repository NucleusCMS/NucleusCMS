...
try_define('_INSTALL_TEXT_ERROR_INSTALLATION_NO_CONFIG_FILE',  'To start the installation, please follow these steps:<ol><li>Rename (or copy) <strong>install-config.sample.php</strong> to <strong>install-config.php</strong></li><li>Edit <strong>install-config.php</strong> and configure authentication:<ul><li><strong>BASIC mode</strong>: Set username and password ($INSTALL_AUTH_USER, $INSTALL_AUTH_PW)</li><li><strong>IP mode</strong>: Set allowed IP address ($INSTALL_MODE = \'IP\', $INSTALL_ALLOW_IP)</li></ul></li><li>Reload this page</li></ol>This procedure ensures that only administrators with server file access can perform the installation.');
