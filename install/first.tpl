...
<body>
<div style="text-align:center; font-size: xx-large;margin-bottom:1em;"><img src="../nucleus/styles/logo.gif"
                                                                            alt="Nucleus CMS"/><br/>
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <select id="lang" name="lang" tabindex="10000"
                                onChange="location.href='index.php?lang='+this.value;">
                            <%lang_options%>
                        </select>
                    </td>
                </tr>
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td><input id="install_db_host" name="install_db_host" value="<%install_db_host_value%>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input id="install_db_database" name="install_db_database"/> (<input
                                    name="install_db_create" value="1" type="checkbox" id="install_db_create"/><label
                                    for="install_db_create"><%_TEXT4_TAB_FIELD4_ADD%></label>)
                        </td>
                    </tr>
                </table>
            </fieldset>
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td><input id="if_IndexURL" name="IndexURL" size="60" value="<%NC_SITE_URL%>" tabindex="10080"/>
                    </td>
                </tr>
                <tr>
                    <td><label for="if_AdminURL"><%_TEXT5_TAB_FIELD2%>:</label></td>
                    <td><input id="if_AdminURL" name="AdminURL" size="60" value="<%NC_SITE_URL%>nucleus/"
                               tabindex="10090"/></td>
                </tr>
                <tr>
                    <td><label for="if_AdminPath"><%_TEXT5_TAB_FIELD3%>:</label></td>
                    <td><input id="if_AdminPath" name="AdminPath" size="60" value="<%NC_BASE_PATH%>nucleus/"
                               tabindex="10100"/></td>
                </tr>
                <tr>
                    <td><label for="if_MediaURL"><%_TEXT5_TAB_FIELD4%>:</label></td>
                    <td><input id="if_MediaURL" name="MediaURL" size="60" value="<%NC_SITE_URL%>media/"
                               tabindex="10110"/></td>
                </tr>
                <tr>
                    <td><label for="if_MediaPath"><%_TEXT5_TAB_FIELD5%>:</label></td>
                    <td><input id="if_MediaPath" name="MediaPath" size="60" value="<%NC_BASE_PATH%>media/"
                               tabindex="10120"/></td>
                </tr>
                <tr>
                    <td><label for="if_SkinsURL"><%_TEXT5_TAB_FIELD6%>:</label></td>
                    <td><input id="if_SkinsURL" name="SkinsURL" size="60" value="<%NC_SITE_URL%>skins/"
                               tabindex="10130"/>
                ...
                <tr>
                    ...
                    <td><input id="if_SkinsPath" name="SkinsPath" size="60" value="<%NC_BASE_PATH%>skins/"
                               tabindex="10140"/>
                        <br/>(<%_TEXT5_TAB_FIELD7_2%>)
                    </td>
                </tr>
                <tr>
                    ...
                    <td><input id="if_PluginURL" name="PluginURL" size="60" value="<%NC_SITE_URL%>nucleus/plugins/"
                               tabindex="10150"/></td>
                </tr>
                <tr>
                    <td><label for="if_ActionURL"><%_TEXT5_TAB_FIELD9%>:</label></td>
                    <td><input id="if_ActionURL" name="ActionURL" size="60" value="<%NC_SITE_URL%>action.php"
                               tabindex="10160"/>
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td><input id="if_User_name" name="User_name" value="" tabindex="10170"/> <small>(<%_TEXT6_TAB_FIELD1_2%>)</small>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input id="if_User_password" name="User_password" type="password" value="" tabindex="10190"/>
                    </td>
                </tr>
                <tr>
                    <td><label for="if_User_password2"><%_TEXT6_TAB_FIELD4%>:</label></td>
                    <td><input id="if_User_password2" name="User_password2" type="password" value="" tabindex="10200"/>
                    </td>
                </tr>
                <tr>
                    <td><label for="if_User_email"><%_TEXT6_TAB_FIELD5%>:</label></td>
                    <td><input id="if_User_email" name="User_email" value="" tabindex="10210"/> <small>(<%_TEXT6_TAB_FIELD5_2%>)</small>
                    </td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input id="if_Blog_shortname" name="Blog_shortname" value="mynucleuscms"/> <small>(<%_TEXT7_TAB_FIELD2_2%>)</small>
                    </td>
                </tr>
            </table>
        </fieldset>
