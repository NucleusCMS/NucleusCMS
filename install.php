<?
	...
	function doInstall() {
		...
		$config_adminemail 	= postVar('AdminEmail');
		$config_sitename 	= postVar('SiteName');
		...
		if (!isValidMailAddress($config_adminemail))			
			array_push($errors,"Invalid e-mail address given for administrator");
