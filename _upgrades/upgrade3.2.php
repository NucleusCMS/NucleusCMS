...
function upgrade_do320() {
    ...
    if (upgrade_checkinstall(320)) return _UPG_TEXT_ALREADY_INSTALLED;
...
function upgrade_do320_addtable_activation() {
    ...
    if (upgrade_checkIfTableExists('activation')) return;
...
function upgrade_do320_addconfig_cookieprefix() {
    ...
    if (upgrade_checkIfCVExists('CookiePrefix')) return;
...
function upgrade_do320_addtable_tickets() {
    ...
    if (upgrade_checkIfTableExists('tickets')) return;
