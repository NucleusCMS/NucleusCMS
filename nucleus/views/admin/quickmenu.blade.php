...
@if($IsLoggedinMenu)
    ...
    <section class="quickmenu-section">
        ...
        <ul id="qmenu_own" class="quickmenu-links">
            <li><a href="{{ ADMIN::getAdminRootURI() }}index.php?action=overview"><svg class="menu-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg><span>{{ _QMENU_USER_HOME }}</span></a></li>
