...
<table>
    ...
    <tr>
        <td>{{ _MEMBERS_CURRENT_PASSWORD }} <span class="required-mark">*</span></td>
    ...
    <tr>
        <td>{{ _MEMBERS_NEW_PASSWORD }} <span class="required-mark">*</span><br />
    ...
    <tr>
        <td>{{ _MEMBERS_REPPWD }} <span class="required-mark">*</span></td>
