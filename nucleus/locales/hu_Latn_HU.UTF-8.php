...
define('_ACTIVATE_CHANGE_TEXT',		'A címed változása ellenőrizve. Köszönjük!');
...
define('_SETTINGS_JSTOOLBAR_SIMPLE','Egyszerű eszköztár (nem Internet Explorer)');
...
define('_LIST_ITEM_AUTHOR',			'szerző:');
define('_LIST_ITEM_DATE',			'dátum:');
define('_LIST_ITEM_TIME',			'idő:');
...
define('_QMENU_LAYOUT_SKINS',		'Bőrök');
...
define('_SETTINGS_EXTAUTH',			'Külső hitelesítés engedélyezése');
define('_WARNING_EXTAUTH',			'Vigyázat: engedélyezés csak ha szükséges.');

// member profile
define('_MEMBERS_BYPASS',			'Külső hitelesítés használata');
...
define('_MEDIA_VIEW_TT',			'Fájl néző (új ablakban)');
define('_MEDIA_FILTER_APPLY',		'Szűrő engedélyezése');
define('_MEDIA_FILTER_LABEL',		'Szűrő:');
...
define('_EBLOG_ALLOWPASTPOSTING',	'Régebbi időpont engedélyezése cikkek jóváhagyásakor/írásakor');
define('_ADD_CHANGEDATE',			'Keletbélyegző frissítése');
define('_BMLET_CHANGEDATE',			'Keletbélyegző frissítése');

// skin import/export
define('_OVERVIEW_SKINIMPORT',		'Bőr import/export...');

// skin settings
define('_PARSER_INCMODE_NORMAL',	'Normál');
define('_PARSER_INCMODE_SKINDIR',	'Bőr könyvtár');
define('_SKIN_INCLUDE_MODE',		'Mód');
define('_SKIN_INCLUDE_PREFIX',		'Prefix');

// global settings
define('_SETTINGS_BASESKIN',		'Alap bőr');
define('_SETTINGS_SKINSURL',		'Bőrök URL-jei');
...
define('_BATCH_UNKNOWN',			'Ismeretlen kötegelt művelet:');
...
define('_BATCH_DELETE_CONFIRM',		'Kötegelt opráció törlésének megerősítése');
define('_BATCH_DELETE_CONFIRM_BTN',	'Kötegelt opráció törlésének megerősítése');
...
define('_ADD_PLUGIN_EXTRAS',		'Extra kiegészítő opciók');

// errors
define('_ERROR_CATCREATEFAIL',		'Nem lehetséges új kategória készítése!');
define('_ERROR_NUCLEUSVERSIONREQ',	'Ehhez a kiegészítőhöz újabb Nucleus verzióra van szükség:');
...
define('_SKINIE_BTN_EXPORT',		'Kiválasztott bőr(ök) exportálása');
define('_SKINIE_LOCAL',				'Helyi fájl importálása:');
define('_SKINIE_NOCANDIDATES',		'A skins könyvtár üres!');
define('_SKINIE_FROMURL',			'Importálás URL-ből:');
define('_SKINIE_EXPORT_INTRO',		'Válaszd ki a bőröket és sablonokat, amiket exportálni szeretnél.');
define('_SKINIE_EXPORT_SKINS',		'Bőrök');
define('_SKINIE_EXPORT_TEMPLATES',	'Sablonok');
define('_SKINIE_EXPORT_EXTRA',		'Extra információ');
define('_SKINIE_CONFIRM_OVERWRITE',	'Létező bőrök felülírása (lásd. névegyezések!)');
define('_SKINIE_CONFIRM_IMPORT',	'Igen, importálni akarom!');
define('_SKINIE_CONFIRM_TITLE',		'Információk bőrök és sablonok importálásáról');
define('_SKINIE_INFO_SKINS',		'Bőrök fájlban:');
define('_SKINIE_INFO_TEMPLATES',	'Sablonok fájlban:');
define('_SKINIE_INFO_GENERAL',		'Információ:');
define('_SKINIE_INFO_SKINCLASH',	'Bőrök neveinek egyezése:');
define('_SKINIE_INFO_TEMPLCLASH',	'Sablokon neveinek egyezése:');
define('_SKINIE_INFO_IMPORTEDSKINS','Importált bőrök:');
...
define('_EDITTEMPLATE_EMPTY',		'üres mező (kattints ide a szerkesztéshez)');
...
define('_BACKUP_NOTE',				'<b>FONTOS:</b> Csak az adatbázis tartalma mentődik. A média fájlok és a config.php beállításai így <b>NEM</b> mentődnek el.');
define('_RESTORE_TITLE',			'Visszaállítás');
define('_RESTORE_NOTE',				'<b>FIGYELMEZTETÉS:</b> A biztonsági mentésből való visszaállítás <b>TÖRÖL</b> minden aktuális Nucleus adatot az adatbázisból! Csak akkor tedd ezt, ha biztos vag a dolgodban!<br/>	<b>Fontos:</b> Legyél biztos benne, hogy a Nucleus verzió, amiből a biztonsági mentést készítetted, megegyezik azzal a Nucleus verzióval, amit jelenleg futtatsz. Ha nem így van, ne használd ezt a funkciót.');
...
define('_RESTORE_WARNING',			'(legyél biztos benne, hogy a megfelelő biztonsági mentés fájl áll a rendelkezésedre)');
...
define('_BMLET_PREVIEW',			'Előnézet');
...
// plugins
define('_CONFIRMTXT_PLUGIN',		'Biztos, hogy törölni akarod a kiegészítőt?');
define('_ERROR_NOSUCHPLUGIN',		'Nincs ilyen kiegészítő.');
define('_ERROR_DUPPLUGIN',			'Sajnálom, ez a plugin már installálva van.');
define('_ERROR_PLUGFILEERROR',		'Nem létező kiegészítő vagy a jogosultság rosszul van beállítva.');
define('_PLUGS_NOCANDIDATES',		'Nem találtam kiegészítőket');
...
define('_PLUGS_TEXT_UPDATE',		'A Nucleus a gyorsítótárban hagyja a kiegészítők beállításait. Amikor upgrade-elsz egy kiegészítőt, azzal, hogy felülírod a fájlt, végre kell hajtanod ezt a frissítést, hogy meggyőződhess róla: a beállítások helyesen kerültek a gyorsítótárba.');
define('_PLUGS_TITLE_NEW',			'Új kiegészítő installálása');
define('_PLUGS_ADD_TEXT',			'Az alábbi listában mindazon kiegészítők szerepelnek, melyek nincsenek installálva. Legyél biztos benne <strong>- egészen biztos -</strong>, hogy amit hozzá akarsz adni a rendszerhez, valóban egy kiegészítő.');
...
// new settings
define('_SETTINGS_PLUGINURL',		'Kiegészítő URL');
define('_SETTINGS_MAXUPLOADSIZE',	'Maximum feltölthető fájlméret (byte-ban)');
...
// file upload
define('_ERROR_DISALLOWEDUPLOAD2',	'Nem rendelkezel adminisztrátori joggal a blogokat illetően, ennélfogva nincs engedélyed fájlok feltöltésére ennek a tagnak a média könyvtárába');
...
define('_LIST_PLUGS_SUBS',			'A következők jóváhagyása:');
...
// plugin options
define('_ERROR_NOPLUGOPTIONS',		'Ez a kiegészítő nem rendelkezik semmilyen beállítással');
define('_PLUGS_BACK',				'Vissza a kiegészítők beállításihoz');
define('_PLUGS_SAVE',				'Opciók mentése');
define('_PLUGS_OPTIONS_UPDATED',	'A kiegészítők opciói frissültek!');
...
define('_MANAGE_SKINS',				'Bőrök és sablonok');
...
define('_ADMINHOME',				'Admin főoldal');
define('_NAME',						'Név');
define('_BACKHOME',					'Vissza az adminisztrációs főoldalra');
define('_BADACTION',				'Nem létező feladat végrehajtását kérted.');
...
define('_LOGIN_PLEASE',				'Először be kell jelentkezned!');
...
define('_ADD_ITALIC_TT',			'dőlt');
define('_ADD_HREF_TT',				'Linket készít');
define('_ADD_MEDIA_TT',				'Média hozzáadása');
define('_ADD_PREVIEW_TT',			'Mutatja/elrejti az előnézetet');
...
define('_EDIT_ORIG_AUTHOR',			'Eredeti szerző');
...
define('_DELETE_CONFIRM',			'Erősítsd meg a törlési műveletet.');
define('_DELETE_CONFIRM_BTN',		'Erősítsd meg a törlési műveletet.');
define('_CONFIRMTXT_ITEM',			'A következőnél tartasz: az alábbi elem törlése:');
define('_CONFIRMTXT_COMMENT',		'A következőnél tartasz: a alábbi megjegyzés törlése:');
define('_CONFIRMTXT_TEAM1',			'A következőnél tartasz: törlés');
define('_CONFIRMTXT_TEAM2',			' a teamlista blogjából.');
define('_CONFIRMTXT_BLOG',			'A blog, amit készülsz, hogy törölj: ');
define('_WARNINGTXT_BLOGDEL',		'Vigyázat! A blog törlésekor a blognak minden elemét és az összes megjegyzést törölni fogod. Kérlek erősítsd meg a törlési kérelmet<br/>Ne kapcsold ki a Nucleust a törlési folyamat közben.');
define('_CONFIRMTXT_MEMBER',		'A következőnél tartasz: a alábbi tag profiljának törlése: ');
define('_CONFIRMTXT_TEMPLATE',		'A következőnél tartasz: a alábbi sablon törlése: ');
define('_CONFIRMTXT_SKIN',			'A következőnél tartasz: a alábbi bőr törlése: ');
define('_CONFIRMTXT_BAN',			'A következőnél tartasz: a alábbi IP bannolása ebbebn a tartománybban:');
define('_CONFIRMTXT_CATEGORY',		'A következőnél tartasz: kategória törlése: ');
...
define('_SKIN_UPDATED',				'A bőr adatai elmentve.');
...
define('_ERROR_NOSUCHSKIN',			'Nem létezik ilyen bőr');
...
define('_ERROR_PASSWORDTOOSHORT',	'A jelszónak legaláb 6 karakterből kell állnia');
define('_ERROR_PASSWORDMISSING',	'Nem lehet üres a jelszó mező');
...
define('_ERROR_ATLEASTONEBLOGADMIN','Ezzel a művelettel jár, hogy a bloghoz nem lehet hozzáférni később, ezért legyél biztos benne, hogy van adminisztráora az oldalnak.');
...
define('_ERROR_DELDEFBLOG',			'Az alap blog nem törölhető!');
define('_ERROR_DELETEMEMBER',		'Ez a tag nem törölhető, lehet, hogy azért, mivel ő a szerzője ennek az megjegyzésnek');
...
define('_ERROR_BADSKINNAME',		'Helytelen bőr elnevezés (a-z és 0-9 lehet, szóközök nélkül)');
define('_ERROR_DUPSKINNAME',		'Egy másik bőr már létezik ezzel a névvel.');
define('_ERROR_DEFAULTSKIN',		'Egy bőrnek mindig "default" elnevezésűnek kell lennie!');
define('_ERROR_SKINDEFDELETE',		'Nem lehet a bőrt törölni, amíg az alap bőr az alábbi bloghoz: ');
define('_ERROR_DISALLOWED',			'Sajnálom, nem hajthatod végre ezt a műveletet.');
define('_ERROR_DELETEBAN',			'Hiba a ban törlése közben (nem létező ban)');
define('_ERROR_ADDBAN',				'Hiba ban hozzáadása közben. Lehet, hogy a ban nem lett korrektül hozzáadva valamelyik bloghoz.');
define('_ERROR_BADACTION',			'A szükséges művelet nem létezik.');
...
define('_ERROR_BANNED1',			'Nem végrehajtható a művelet, amíg az alábbi IP tartományból jössz: ');
define('_ERROR_BANNED2',			' . Az üzenet a következő: \'');
define('_ERROR_BANNED3',			'\'');
define('_ERROR_LOGINNEEDED',		'Be kell jelentkezned a művelet végrehajtásához.');
...
define('_ERROR_NOSUCHLOCALE',		'Nem létező nelvi fájl!');
...
define('_MSG_ACTIONLOGCLEARED',		'Műveletek log törölve.');

// actionlog in admin area
define('_ACTIONLOG_DISALLOWED',		'Tiltott művelet: ');
define('_ACTIONLOG_PWDREMINDERSENT','Új jelszó elküldve: ');
define('_ACTIONLOG_TITLE',			'Műveletek logja');
define('_ACTIONLOG_CLEAR_TITLE',	'Műveletek logjának törlése');
define('_ACTIONLOG_CLEAR_TEXT',		'Műveletek logjának törlése most');
...
define('_EBLOG_DEFSKIN',			'Alap bőr');
...
define('_EBLOG_NOTIFY',				'Értesítő címek (használata; mint elválasztó)');
...
define('_EBLOG_MAXCOMMENTS',		'Max. mennyiség a megjegyzésekből!');
define('_EBLOG_UPDATE',				'Fájl frissítése');
define('_EBLOG_OFFSET',				'Időeltolódás');
define('_EBLOG_STIME',				'Aktuális szerveridő: ');
define('_EBLOG_BTIME',				'Aktuális blog idő: ');
...
define('_EBLOG_CREATE_TEXT',		'Töltsd ki az alábbi mezőt új blog létrehozásához. <br /><br /> <b>Figyelem:</b> Csak a szükséges opciók vannak kilistázva. Ha extra opciókat szeretnél beállítani, kattints a blogbeállításokra a lap alján az "új blog létrehozása" alatt.');
...
define('_TEMPLATE_AVAILABLE_TITLE',	'Elérhető sablonok');
...
define('_TEMPLATE_CMANY',			'Kettő vagy (több) megjegyzés');
...
// skins
define('_SKIN_EDIT_TITLE',			'Bőrök szerkesztése');
define('_SKIN_AVAILABLE_TITLE',		'Elérhető bőrök');
define('_SKIN_NEW_TITLE',			'Új bőr');
define('_SKIN_NAME',				'Név');
define('_SKIN_DESC',				'Leírás');
define('_SKIN_TYPE',				'Tartalom típusa');
define('_SKIN_CREATE',				'Létrehozás');
define('_SKIN_CREATE_BTN',			'Bőr létrehozása');
define('_SKIN_EDITONE_TITLE',		'Bőr szerkesztése');
define('_SKIN_BACK',				'Vissza a bőrök beállításaihoz');
define('_SKIN_PARTS_TITLE',			'Bőrök részei');
define('_SKIN_PARTS_MSG',			'Nem szükséges az összs típus a bőrökhöz. Hagyd üresen, amire nincs szükséged. Válassz egy alábbi bőrtípust a szerkesztéshez:');
define('_SKIN_PART_MAIN',			'Főoldal');
...
define('_SKIN_UPDATE_BTN',			'Bőr frissítése');
define('_SKIN_RESET_BTN',			'Adat visszaállítás');
define('_SKIN_EDITPART_TITLE',		'Bőr szerkesztése');
define('_SKIN_GOBACK',				'Vissza');
define('_SKIN_ALLOWEDVARS',			'Elérhető változók (kattints rá a bővebb információért):');
...
define('_SETTINGS_COOKIEMONTH',		'Egy hónap életidő');
...
define('_BAN_BLOGS_TEXT',			'Lehetőséged van választani egy bloghoz kötött IP-t bannolni, vagy pedig bannolni az IP-t az összes bloghoz, ahol admininsztrátori jogokkal rendelkezel.');
...
define('_BLOGLIST_BMLET',			'Könyvjelző');
...
define('_OVERVIEW_SKINS',			'Bőrök szerkesztése...');
...
define('_LISTS_PREV',				'Előző');
define('_LISTS_NEXT',				'Következő');
...
define('_LIST_COMMENT_WHO',			'Szerző');
