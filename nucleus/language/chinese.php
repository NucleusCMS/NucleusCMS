...
define('_ERROR_ADDBAN',				'添加规定的时候发生错误. 规定可能没有在你的所有日志里正确的添加.');
...
define('_ERROR_DISALLOWEDUPLOAD',	'你不在任何日志的团队列表中，不具备上传文件的权利');
...
define('_EBLOG_CREATE_TEXT',		'填写下面的表单创建一个新日志. <br /><br /> <b>注意:</b> 只有必要的选项在列表中，如果你想更改更多的选项，创建后再到相应的设置中去修改.');
...
define('_BAN_REASON_TEXT',			'你可以为封锁提供一个原因,当被禁止的IP所有者试图添加另一条评论或者是投票时显示.最大256个字符.');
