...
// 2003-11-17 --- revised by Peter Müller
...
define('_PLUGS_ADD_TEXT',			'Unten steht eine Liste von m&ouml;glichen, nicht installierten Plugins. Bitte <strong>vor dem Installieren sicherstellen</strong>, dass es tatsächlich ein Plugin ist.');
define('_PLUGS_BTN_INSTALL',		'Plugin installieren');
define('_BACKTOOVERVIEW',			'Zur&uuml;ck zur Übersicht');
...
define('_SETTINGS_MAXUPLOADSIZE',	'Max. Dateigr&ouml;ße (Bytes)');
define('_SETTINGS_NONMEMBERMSGS',	'Nicht-Mitgliedern Nachrichten erlauben');
...
define('_PLUGS_SAVE',				'Optionen f&uuml;r Plugin speichern');
define('_PLUGS_OPTIONS_UPDATED',	'Optionen f&uuml;r Plugin aktualisiert');
define('_OVERVIEW_MANAGEMENT',		'Verwaltung von Nucleus');
define('_OVERVIEW_MANAGE',			'Einstellungen f&uuml;r Nucleus verwalten ...');
define('_MANAGE_GENERAL',			'Allgemeine Einstellungen f&uuml;r Nucleus');
define('_MANAGE_SKINS',				'Skins und Templates');
define('_MANAGE_EXTRA',				'Spezielle Einstellungen f&uuml;r Nucleus');

define('_BACKTOMANAGE',				'Zur&uuml;ck zur Verwaltung von Nucleus');
...
define('_COMMENTFORM_SUBMIT',		'Diesen Kommentar hinzuf&uuml;gen');
define('_COMMENTFORM_COMMENT',		'Ihr Kommentar');
define('_COMMENTFORM_NAME',			'Ihr Name');
define('_COMMENTFORM_MAIL',			'Ihre Email-Adresse');
...
define('_LOGINFORM_SHARED',			'Dieser Rechner ist &ouml;ffentlich (Shared Login)');
...
// add item form
define('_ADD_ADDTO',				'Neuer Artikel für');
...
define('_EDIT_SUBMIT',				'Artikel &auml;ndern');
define('_EDIT_ORIG_AUTHOR',			'Autor - Urheber');
define('_EDIT_BACKTODRAFTS',		'Entwurf aktualisieren');
...
define('_CONFIRMTXT_ITEM',			'Sie l&ouml;schen folgenden Artikel:');
define('_CONFIRMTXT_COMMENT',		'Sie l&ouml;schen folgenden Kommentar:');
define('_CONFIRMTXT_TEAM1',			'Sie  l&ouml;schen ');
define('_CONFIRMTXT_TEAM2',			' aus der Teamliste ');
define('_CONFIRMTXT_BLOG',			'Folgender Weblog soll gel&ouml;scht werden: ');
define('_WARNINGTXT_BLOGDEL',		'Achtung! Beim L&ouml;schung des Weblogs werden alle Artikel und Kommentare mitgel&ouml;scht. Bitte best&auml;tigen Sie diese Aktion noch einmal!<br />Bitte Nucleus w&auml;hrend des L&ouml;schvorgangs nicht unterbrechen.');
...
define('_CONFIRMTXT_SKIN',			'Sie sind dabei, folgenden Skin zu l&ouml;schen ');
...
define('_ERROR_NOTONDESTTEAM',		'Artikel kann nicht in dieses Weblog verschoben werden. Sie sind dort kein Mitglied');
...
define('_ERROR_UPDATEFILE',			'Habe keine Schreibrechte f&uuml;r die Update-Datei. Bitte Rechte korrekt setzen (chmod 666). Bitte ber&uuml;cksichtigen, dass der Speicherplatz relativ zum Admin-Ordner liegt, eventuell also absoluten Pfad angeben (z.B. /home/www/site10/web/nucleus/)');
...
define('_ERROR_DUPSKINNAME',		'Eine Skin mit diesem Namen ist bereits vorhanden');
define('_ERROR_DEFAULTSKIN',		'Es muss immer eine Skin mit dem Namen "default" geben');
define('_ERROR_SKINDEFDELETE',		'Skin "default" kann nicht gel&ouml;scht werden f&uuml;r Hauptthema: ');
...
define('_ERROR_BADPERMISSIONS',		'Zugriffsrechte f&uuml;r Datei oder Ordner falsch gesetzt');
...
define('_WARNING_NOTADIR',			'Achtung: Dieser Wert ist kein Ordner!');
define('_WARNING_NOTREADABLE',		'Achtung: Dieser Wert ist ein nicht-lesbares Ordner!');
define('_WARNING_NOTWRITABLE',		'Achtung: Dieser Wert ist ein nicht beschreibbarer Ordner!');
...
define('_MSG_LOGINAGAIN',			'Sie m&uuml;ssen sich nach der &Auml;nderung Ihrer Benutzerdaten neu anmelden');
define('_MSG_SETTINGSCHANGED',		'Einstellungen ge&auml;ndert');
define('_MSG_ADMINCHANGED',			'Administrator ge&auml;ndert');
define('_MSG_NEWBLOG',				'Neuer Weblog angelegt');
define('_MSG_ACTIONLOGCLEARED',		'Aktionsordner gel&ouml;scht');

// actionlog in admin area
define('_ACTIONLOG_DISALLOWED',		'Verbotene Aktion: ');
define('_ACTIONLOG_PWDREMINDERSENT','Neues Passwort geschickt an ');
define('_ACTIONLOG_TITLE',			'Aktionsordner');
define('_ACTIONLOG_CLEAR_TITLE',	'Aktionsordner l&ouml;schen');
define('_ACTIONLOG_CLEAR_TEXT',		'Aktionsordner jetzt l&ouml;schen');

// team management
define('_TEAM_TITLE',				'Team verwalten f&uuml;r Weblog ');
...
define('_TEMPLATE_ITEMFOOTER',		'Artikel Fuss');
define('_TEMPLATE_MORELINK',		'Link zu MORE');
...
define('_TEMPLATE_CFOOTER',			'Kommentar Fuss');
...
define('_TEMPLATE_SNOTFOUND',		'Ihre Suche brachte keine Ergebnisse');
...
define('_SKIN_NEW_TITLE',			'Neuen Skin');
...
define('_SKIN_PARTS_TITLE',			'Skin Teile');
define('_SKIN_PARTS_MSG',			'Nicht alle Teile werden f&uuml;r Skin ben&ouml;tigt. Nicht ben&ouml;tigte Teile leer lassen. Skin zum Bearbeiten ausw&auml;hlen:');
define('_SKIN_PART_MAIN',			'Haupt&uuml;bersicht');
define('_SKIN_PART_ITEM',			'Detailseiten');
...
define('_SKIN_UPDATE_BTN',			'Skin aktualisieren');
...
define('_SETTINGS_DIRS',			'Ordner von Nucleus');
define('_SETTINGS_MEDIADIR',		'Ordner für Medien');
...
define('_SETTINGS_COOKIELIFE',		'Cookie-Lebensdauer f&uuml;r Benutzer');
define('_SETTINGS_COOKIESESSION',	'Session Cookies');
define('_SETTINGS_COOKIEMONTH',		'Lebensdauer: 1 Monat');
define('_SETTINGS_LASTVISIT',		'Cookie für letzten Besuch speichern');
...
define('_SETTINGS_UPDATE',			'Update Einstellungen');
define('_SETTINGS_UPDATE_BTN',		'Update Einstellungen');
...
define('_BAN_BLOGS_TEXT',			'Sie k&ouml;nnen wahlweise nur einen Weblog sperren, oder alle Punkte in Ihrem Admin-Bereich. Bitte ausw&auml;hlen.');
...
define('_BLOGLIST_ADD',				'Neue Artikel hinzuf&uuml;gen');
...
define('_BLOGLIST_TT_EDIT',			'Bereits vorhandene Artikel in diesem Weblog bearbeiten');
define('_BLOGLIST_BMLET',			'Bookmarklets'); 
define('_BLOGLIST_TT_BMLET',		'Bookmarklets verwalten');
define('_BLOGLIST_SETTINGS',		'Einstellungen');
define('_BLOGLIST_TT_SETTINGS',		'Einstellungen &auml;ndern oder Benutzer verwalten. Gilt nur f&uuml;r dieses Weblog.');
...
define('_OVERVIEW_YRSETTINGS',		'Benutzereinstellungen');
...
define('_OVERVIEW_EDITSETTINGS',	'Ihre Benutzereinstellungen bearbeiten ...');
define('_OVERVIEW_BROWSEITEMS',		'Ihre Artikel auflisten ...');
define('_OVERVIEW_BROWSECOMM',		'Ihre Kommentare auflisten ...');
define('_OVERVIEW_VIEWLOG',			'Aktions-History anschauen ...');
define('_OVERVIEW_MEMBERS',			'Benutzer verwalten ...');
define('_OVERVIEW_NEWLOG',			'Neuen Weblog erstellen ...');
define('_OVERVIEW_SETTINGS',		'Allgemeine Einstellungen bearbeiten ...');
...
// ITEMLIST
define('_ITEMLIST_BLOG',			'Artikel f&uuml;r Weblog'); 
...
define('_LISTS_TITLE',				'Titel des Artikels');
...
// move item
define('_MOVE_TITLE',				'In welchen Weblog verschieben?');
...
define('_SKIN_UPDATED',				'Skin wurde aktualisiert'); 
define('_TEMPLATE_UPDATED',			'Template wurde aktualisiert');
...
define('_EBLOG_NOTIFY_ITEM',        'Neue Weblog-Artikel');
define('_ADD_CATEGORY',             'Kategorie');
define('_ADD_DRAFTNFUTURE',         'Artikel hinzuf&uuml;gen');
...
define('_EBLOG_ALLOWPASTPOSTING',	'Artikel in der Vergangenheit erlauben');
define('_ADD_CHANGEDATE',			'Zeitstempel &auml;ndern');
define('_BMLET_CHANGEDATE',			'Zeitstempel &auml;ndern');

// skin import/export
define('_OVERVIEW_SKINIMPORT',		'Skins/Templates importieren/exportieren...');

// skin settings
define('_PARSER_INCMODE_NORMAL',	'Normal');
define('_PARSER_INCMODE_SKINDIR',	'Skinordner benutzen ');
...
define('_BATCH_DELETE_CONFIRM',		'Batch l&ouml;schen best&auml;tigen');
...
define('_BATCH_CAT_MOVE',			'In anderes Weblog verschieben');
...
// backlinks
define('_BACK_TO_BLOGSETTINGS',		'Zur&uuml;ck zu den Weblogeinstellungen');
...
define('_BACKUP_ZIP_YES',			'Komprimierung versuchen (*.sql.gz)');
define('_BACKUP_ZIP_NO',			'Keine Komprimierung versuchen (*.sql)');
...
define('_NOTIFY_NI_MSG',			'Ein neuer Artikel wurde verfasst:');
define('_NOTIFY_NI_TITLE',			'Neuer Artikel!');
define('_NOTIFY_KV_MSG',			'Karma zu Artikel:');
define('_NOTIFY_KV_TITLE',			'Nucleus Karma:');
define('_NOTIFY_NC_MSG',			'Kommentar zu Artikel:');
...
define('_MMAIL_FROMANON',			'einem anonymen Besucher');
define('_MMAIL_FROMNUC',			'Geschrieben vom Nucleus Weblog bei');
