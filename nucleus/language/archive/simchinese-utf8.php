<?php
// simple Chinese language file 简体中文语言文件
// Author(作者): buska
// Author Homepage(作者主页):http://buska.yeah.net
...
if (!defined('_LOCALE'))  define('_LOCALE',  'zh_Hans');  // common locale gb2312
if (!defined('_LOCALE_NAME_WINDOWS'))  define('_LOCALE_NAME_WINDOWS', 'zh-Hans');
...
// media library
define('_MEDIA_VIEW',				'察看');
define('_MEDIA_VIEW_TT',			'察看文件 (在新窗口打开)');
define('_MEDIA_FILTER_APPLY',		'申请过滤');
define('_MEDIA_FILTER_LABEL',		'过滤: ');
define('_MEDIA_UPLOAD_TO',			'上传到...');
define('_MEDIA_UPLOAD_NEW',			'上传新文件...');
define('_MEDIA_COLLECTION_SELECT',	'选择');
define('_MEDIA_COLLECTION_TT',		'转换到此类别');
...
define('_EBLOG_SEARCH',				'搜索中包含');

// generic upload failure
define('_ERROR_UPLOADFAILED',		'上传失败');
...
define('_SETTINGS_ACTIONSURL',		'action.php完整的URL');

// category moves (batch)
define('_ERROR_MOVEDEFCATEGORY',	'不能移动默认类别');
define('_ERROR_MOVETOSELF',			'无法移动类别（描述版区与源版区相同)');
...
define('_SETTINGS_URLMODE_PATHINFO','喜欢');
...
define('_BATCH_CAT_MOVE',			'移动到其他版区');
...
define('_ERROR_NUCLEUSVERSIONREQ',	'该插件需要更新版本的该系统: ');

// backlinks
define('_BACK_TO_BLOGSETTINGS',		'返回版区设置');
...
define('_NOTIFY_NI_MSG',			'一篇新文章已经被发表:');
...
// file upload
define('_ERROR_DISALLOWEDUPLOAD2',	'你没有将文件上传到会员多媒体目录的权利');
...
define('_BACK',						'返回');
define('_NOTLOGGEDIN',				'未登陆');
define('_LOGGEDINAS',				'登陆以身份');
...
define('_MESSAGE',					'消息');
define('_HELP_TT',					'帮助!');
define('_YOURSITE',					'你的网站');


define('_POPUP_CLOSE',				'关闭窗口');

define('_LOGIN_PLEASE',				'请先登陆');
...
define('_LOGINFORM_YOUARE',			'登陆以身份');
...
define('_CONFIRMTXT_TEAM2',			'从版区团队列表中');
define('_CONFIRMTXT_BLOG',			'你将要删除的版区为:');
define('_WARNINGTXT_BLOGDEL',		'警告!删除版区将会删除其上的的所有文章和评论。请确定是否真的要删除版区<br />同时，在移动版区时不要终止系统.');
...
define('_ERROR_COMMENTS_DISABLED',	'这个版区的评论已经被禁止.');
define('_ERROR_COMMENTS_NONPUBLIC',	'你必须以会员身份登陆才可以添加评论');
...
define('_ERROR_NOSUCHBLOG',			'没有这个版区');
define('_ERROR_NOSUCHSKIN',			'没有这个皮肤');
define('_ERROR_NOSUCHMEMBER',		'没有这个会员');
define('_ERROR_NOTONTEAM',			'你不在该版区的团队列表上.');
...
define('_ERROR_ATLEASTONEADMIN',	'系统至少应该存在一个可以登陆到管理界面的超级用户.');
define('_ERROR_ATLEASTONEBLOGADMIN','请确定总是至少有一个超级用户.');
define('_ERROR_ALREADYONTEAM',		'团队中已经存在这个会员');
define('_ERROR_BADSHORTBLOGNAME',	'版区缩写只允许包含a-z,0-9');
define('_ERROR_DUPSHORTBLOGNAME',	'其他版区已经使用这个缩写名称');
define('_ERROR_UPDATEFILE',			'不能通过写入升级文件.请确定文件权限设置正确(试改为666).)');
define('_ERROR_DELDEFBLOG',			'不能删除默认版区');
define('_ERROR_DELETEMEMBER',		'该会员无法删除,可能他是文章或评论的作者');
...
define('_ERROR_DUPSKINNAME',		'已存在这样一个名字的皮肤');
define('_ERROR_DEFAULTSKIN',		'系统必须有一个默认皮肤名为"default"');
define('_ERROR_SKINDEFDELETE',		'这是默认皮肤,不能删除: ');
define('_ERROR_DISALLOWED',			'对不起,你没有权利执行该动作');
define('_ERROR_DELETEBAN',			'删除规定的时候发生错误. (规定不存在)');
define('_ERROR_ADDBAN',				'添加规定的时候发生错误. 规定可能没有在你的所有版区里正确的添加.');
define('_ERROR_BADACTION',			'需要的动作不存在');
define('_ERROR_MEMBERMAILDISABLED',	'会员到会员的邮件消息是禁止的');
define('_ERROR_MEMBERCREATEDISABLED','会员账号建立是禁止的');
define('_ERROR_INCORRECTEMAIL',		'不正确的邮件地址');
define('_ERROR_VOTEDBEFORE',		'你已经为这个文章投过票了');
define('_ERROR_BANNED1',			'无法执行 (IP封锁');
define('_ERROR_BANNED2',			') 被禁止. 消息为: \'');
define('_ERROR_BANNED3',			'\'');
define('_ERROR_LOGINNEEDED',		'执行这个动作必须登陆');
define('_ERROR_CONNECT',			'连接错误');
define('_ERROR_FILE_TOO_BIG',		'文件太大!');
define('_ERROR_BADFILETYPE',		'对不起，不允许上传这种文件格式');
define('_ERROR_BADREQUEST',			'无效的上传请求');
define('_ERROR_DISALLOWEDUPLOAD',	'你不在任何版区的团队列表中，不具备上传文件的权利');
define('_ERROR_BADPERMISSIONS',		'文件/目录权限没有正确设置');
define('_ERROR_UPLOADMOVEP',		'上传文件时发生错误');
define('_ERROR_UPLOADCOPY',			'拷贝文件时发生错误');
define('_ERROR_UPLOADDUPLICATE',	'已经有一个此名称的文件，上传之前请先改名。');
define('_ERROR_LOGINDISALLOWED',	'对不起你不能登陆管理区，只能以其他用户身份登陆');
define('_ERROR_DBCONNECT',			'无法连接到 MySQL 服务器');
define('_ERROR_DBSELECT',			'无法选择文章系统的数据库');
define('_ERROR_NOSUCHLANGUAGE',		'不存在这个语言文件');
define('_ERROR_NOSUCHCATEGORY',		'不存在这个类别');
define('_ERROR_DELETELASTCATEGORY',	'至少一个类别');
define('_ERROR_DELETEDEFCATEGORY',	'不能删除默认类别');
define('_ERROR_BADCATEGORYNAME',	'无效类别名');
define('_ERROR_DUPCATEGORYNAME',	'已经存在以该名称命名的类别');
...
define('_UPLOAD_MSG',				'从下面选择你向上传的文件,并且点击 \'Upload\' 按钮.');
define('_UPLOAD_BUTTON',			'上传');

// some status messages
define('_MSG_ACCOUNTCREATED',		'账号建立,密码将会通过邮件通知你');
define('_MSG_PASSWORDSENT',			'密码已由邮件发出。');
define('_MSG_LOGINAGAIN',			'你需要重新登陆，因为你的信息已经改变。');
define('_MSG_SETTINGSCHANGED',		'设置改变');
define('_MSG_ADMINCHANGED',			'管理员改变');
define('_MSG_NEWBLOG',				'新的版区已建立');
...
// blogsettings
define('_EBLOG_TITLE',				'编辑版区设置');
define('_EBLOG_TEAM_TITLE',			'编辑团队');
define('_EBLOG_TEAM_TEXT',			'点击这里编辑你的团队...');
define('_EBLOG_SETTINGS_TITLE',		'版区设置');
define('_EBLOG_NAME',				'版区名');
define('_EBLOG_SHORTNAME',			'版区名缩写');
define('_EBLOG_SHORTNAME_EXTRA',	'<br />(只允许包含 a-z )');
define('_EBLOG_DESC',				'版区描述');
...
define('_EBLOG_NOTIFY_ITEM',		'新的版区');
...
define('_EBLOG_BTIME',				'当前版区时间为');
define('_EBLOG_CHANGE',				'改变设置');
define('_EBLOG_CHANGE_BTN',			'改变设置');
define('_EBLOG_ADMIN',				'版区管理员');
define('_EBLOG_ADMIN_MSG',			'You will be assigned admin privileges');
define('_EBLOG_CREATE_TITLE',		'创建新版区');
define('_EBLOG_CREATE_TEXT',		'填写下面的表单创建一个新版区. <br /><br /> <b>注意:</b> 只有必要的选项在列表中，如果你想更改更多的选项，创建后再到相应的设置中去修改.');
define('_EBLOG_CREATE',				'创建!');
define('_EBLOG_CREATE_BTN',			'创建版区');
...
define('_TEMPLATE_MORELINK',		'连接到扩展entry');
...
define('_TEMPLATE_COMMENTS_TOOMUCH','Comments (太多无法在线显示)');
...
define('_SKIN_PART_POPUP',			'图像popups');
...
define('_SETTINGS_DEFBLOG',			'默认版区');
define('_SETTINGS_ADMINMAIL',		'超级管理员邮件');
define('_SETTINGS_SITENAME',		'网站名称');
define('_SETTINGS_SITEURL',			'网站的URL(应该以斜线"/"结束)');
define('_SETTINGS_ADMINURL',		'管理员区域的URL(应该以斜线"/"结束)');
define('_SETTINGS_DIRS',			'系统目录');
define('_SETTINGS_MEDIADIR',		'Media 目录');
define('_SETTINGS_SEECONFIGPHP',	'(察看 config.php)');
define('_SETTINGS_MEDIAURL',		'Media URL ((应该以斜线"/"结束))');
define('_SETTINGS_ALLOWUPLOAD',		'允许文件上传?');
define('_SETTINGS_ALLOWUPLOADTYPES','允许上传文件的类型');
define('_SETTINGS_CHANGELOGIN',		'允许会员更改登陆密码');
...
define('_SETTINGS_COOKIEDOMAIN',	'Cookie Domain (高级)');
define('_SETTINGS_COOKIESECURE',	'Secure Cookie (高级)');
define('_SETTINGS_LASTVISIT',		'保存上次访问的Cookies');
define('_SETTINGS_ALLOWCREATE',		'允许访客建立会员账号');
define('_SETTINGS_NEWLOGIN',		'允许访客建立的账号登陆');
...
define('_SETTINGS_DBLOGIN',			'mySQL 登陆 &amp; 数据库');
...
define('_BAN_NONE',					'改版区没有任何规定');
define('_BAN_NEW_TITLE',			'添加新的封锁');
define('_BAN_NEW_TEXT',				'现在添加一条新的封锁');
define('_BAN_REMOVE_TITLE',			'删除规定');
define('_BAN_IPRANGE',				'IP封锁');
define('_BAN_BLOGS',				'哪个版区?');
define('_BAN_DELETE_TITLE',			'删除规定');
define('_BAN_ALLBLOGS',				'你拥有管理员权利的所有版区.');
define('_BAN_REMOVED_TITLE',		'封锁移除');
define('_BAN_REMOVED_TEXT',			'从以下版区移除封锁:');
define('_BAN_ADD_TITLE',			'添加封锁');
define('_BAN_IPRANGE_TEXT',			'选择你要封锁的IP.');
define('_BAN_BLOGS_TEXT',			'你可以在你拥有权限的版区内封锁IP.');
define('_BAN_REASON_TITLE',			'原因');
define('_BAN_REASON_TEXT',			'你可以表明封锁的原因，这样当被封锁者再次试图添加评论的时候就可以得到提醒，内容最多为256字符.');
...
define('_BLOGLIST_TT_ADD',			'在这个版区中添加新文章');
...
define('_BLOGLIST_TT_DELETE',		'删除该版区');

// OVERVIEW screen
define('_OVERVIEW_YRBLOGS',			'你的版区');
...
define('_OVERVIEW_NEWLOG',			'建立新的版区...');
...
define('_LIST_MEMBER_LOGIN',		'能够登陆?');
...
// commentlist
define('_LIST_COMMENT_BANIP',		'禁止 IP');
