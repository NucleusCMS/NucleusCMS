...
class Entity
{
	...
	/**
	 * Entity::decodeURIComponent()
	 * 
	 * @param	string	$string	string encoded by encodedURIComponent() of JavaScript
	 ...
	 * @link	http://msdn.microsoft.com/en-us/library/ht8a077w(v=vs.94).aspx
	 * decodeURIComponent Function (JavaScript)
	 * @link	http://msdn.microsoft.com/en-us/library/91b80x6x(v=vs.94).aspx
	 * encodeURI Function (JavaScript)
	 * @link	http://msdn.microsoft.com/en-us/library/xh9be5xc(v=vs.94).aspx
	 * encodeURIComponent Function (JavaScript)
	 * @link	http://msdn.microsoft.com/en-us/library/aeh9cef7(v=vs.94).aspx
	 * escape Function (JavaScript)
	 * @link	http://msdn.microsoft.com/en-us/library/9yzah1fh(v=vs.94).aspx
	 * unescape Function (JavaScript)
	 * @link	http://msdn.microsoft.com/en-us/library/dz4x90hk(v=vs.94).aspx
	 * 
	 * Mozilla Developer Network
	 * JavaScript Reference
	 * decodeURI
	 * @link	https://developer.mozilla.org/ja/JavaScript/Reference/Global_Objects/decodeURI
	 * decodeURIComponent
	 * @link	https://developer.mozilla.org/ja/JavaScript/Reference/Global_Objects/decodeURIComponent
	 * encodeURI
	 * @link	https://developer.mozilla.org/ja/JavaScript/Reference/Global_Objects/encodeURI
	 * encodeURIComponent
	 * @link	https://developer.mozilla.org/ja/JavaScript/Reference/Global_Objects/encodeURIComponent
	 * escape
	 * @link	https://developer.mozilla.org/ja/DOM/window.escape
	 * unescape
	 * @link	https://developer.mozilla.org/ja/DOM/window.unescape
	 * 
	 * NOTE:
	 * decodeURI/decodeURIComponent/encodeURI/encodeURIComponent are in specification,
	 * but escape/unescape is defferent for each vendor's implement.
	 * For example, Microsoft defines it as one of Global Object
	 * @link	http://msdn.microsoft.com/en-us/library/52f50e9t(v=vs.94).aspx
	 * But Mozilla define it as one of methods in DOM Window Object
	 * @link	https://developer.mozilla.org/ja/DOM/window
	 * 
	 * NOTE:
	 * urldecode() already applied to each elements in $_GET/$_POST/$_REQUEST/$_COOKIE 
	 ...
	 */
	static public function decodeURIComponent($string)
	{
		/* In this translation, it's OK just to use this function */
	 ...
	 * Entity::decodeURI()
	 * 
	 * @param	string	$string	string encoded by encodedURI() of JavaScript
	 * @return	string	decoded string
	 * 
	 * @see	Entity::decodeURIComponent()
	 */
	static public function decodeURI($string)
	{
		/* In this translation, it's OK just to use this function */
		return rawurldecode($string);
	}
