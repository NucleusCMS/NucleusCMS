...
//
// New Translation by Peter Müller, info@groningen-info.de 
...
define('_MEDIA_COLLECTION_SELECT',	'Auswählen');
...
define('_BMLET_BODY',				'Inhalt'); // war "Einführung" 
...
// file upload
define('_ERROR_DISALLOWEDUPLOAD2',	'Stimmen die Dateirechte (CHMOD 777)?'); // war "ungenügende Rechte" 
...
define('_EDIT_BACKTODRAFTS',		'Als Entwurf '); //hier stand was mit "Hintergrund ergänzen" oder so. 
...
define('_ERROR_COMMENT_NOUSERNAME',	'Benutzername ist nicht gültig.');
...
define('_ERROR_REALNAMEMISSING',	'Sie m&uuml;ssen Ihren vollständigen Namen angeben');
...
define('_MEDIA_MODIFIED',			'Datum'); // war "geändert" 
...
// blogsettings
define('_EBLOG_TITLE',				'Einstellungen für Blog');
...
define('_SETTINGS_LASTVISIT',		'Cookie für letzten Besuch (last visit) aktivieren');
...
define('_BLOGLIST_TT_ADD',			'Neuen Artikel für dieses Blog schreiben');
define('_BLOGLIST_EDIT',			'Artikel &auml;ndern');
define('_BLOGLIST_TT_EDIT',			'Einen bereits vorhandenen Artikel für dieses Blog bearbeiten oder l&ouml;schen');
...
define('_EBLOG_ALLOWPASTPOSTING',	'Veröffentlichung in der Vergangenheit erlauben?');
...
define('_ITEMLIST_ADDNEW',			'Artikel schreiben'); // war "Hinzufügen" 
...
define('_ERROR_NUCLEUSVERSIONREQ',	'Das Plugin braucht eine neuere Nucleus-Version: '); //"Nucleus-" ergänzt 
...
// member mail message
define('_MMAIL_MSG',				'Nucleus: Eine Nachricht von'); // ergänzt "Nucleus: " 
define('_MMAIL_FROMANON',			'Anonymer Besucher');
define('_MMAIL_FROMNUC',			'Geschrieben von einem Nucleus Blog bei'); 
define('_MMAIL_TITLE',				'Nucleus: Eine Nachricht von'); // ergänzt "Nucleus: " 
