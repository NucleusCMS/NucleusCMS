...
define('_LIST_PLUG_SUBS_NEEDUPDATE','Bitte benutzen Sie den \'Update Subscribtion list\'-Button zum Update der Plugin-Abonnementliste.');
...
define('_ACTIVATE_REGISTER_MAIL',	"Hi <%memberName%>,\n\nSie m&uuml;ssen Ihren Account auf <%siteName%> (<%siteUrl%>) aktivieren.\nSie k&ouml;nnen dies durch Klick auf den nachstehenden Link erledigen: \n\n\t<%activationUrl%>\n\nSie haben daf&uuml;r zwei Tage. Danach wird dieser Aktivierungslink ung&uuml;ltig.");
define('_ACTIVATE_REGISTER_MAILTITLE',	"Aktivieren Sie Ihren '<%memberName%>'-Account");
define('_ACTIVATE_REGISTER_TITLE',	'Willkommen, <%memberName%>');
define('_ACTIVATE_REGISTER_TEXT',	'Sie sind fast fertig. Bitte w&auml;hlen Sie ein Passwort für den nachstehenden Account.');
define('_ACTIVATE_FORGOT_MAIL',		"Hi <%memberName%>,\n\nMit dem nachstehenden Link k&ouml;nnen Sie ein neues Passwort f&uuml;r Ihren Account auf <%siteName%> (<%siteUrl%>) bestimmen.\n\n\t<%activationUrl%>\n\nSie haben daf&uuml;r zwei Tage. Danach wird dieser Aktivierungslink ung&uuml;ltig.");
define('_ACTIVATE_FORGOT_MAILTITLE',"Reaktivieren Sie Ihren '<%memberName%>'-Account");
define('_ACTIVATE_FORGOT_TITLE',	'Willkommen, <%memberName%>');
define('_ACTIVATE_FORGOT_TEXT',		'Sie k&ouml;nnen f&uuml;r den nachstehenden Account ein neues Passwort bestimmen:');
define('_ACTIVATE_CHANGE_MAIL',		"Hallo <%memberName%>,\n\nDa Ihre eMail-Adresse ge&auml;ndert wurde, m&uuml;ssen Sie Ihren Account bei <%siteName%> (<%siteUrl%>) neu aktivieren.\nSie k&ouml;nnen dies durch Klick auf den nachstehenden Link erledigen: \n\n\t<%activationUrl%>\n\nSie haben daf&uuml;r zwei Tage. Danach wird dieser Aktivierungslink ung&uuml;ltig.");
define('_ACTIVATE_CHANGE_MAILTITLE',"Ereute Aktivierung Ihres '<%memberName%>'-Accounts");
...
define('_ACTIVATE_SUCCESS_TEXT',	'Ihr Account wurde erfolgreich aktiviert.');
define('_MEMBERS_SETPWD',			'Passwort setzen');
define('_MEMBERS_SETPWD_BTN',		'Passwort setzen');
...
define('_PLUGINS_EXTRA',			'Extra Plugin-Einstellungen');
...
define('_QMENU_INTRO_TEXT',			'<p>Dies ist die Login-Seite f&uuml;r das Nucleus CMS, dem Content Management-System zur Verwaltung diese Website.</p><p>Wenn Sie einen Account besitzen, k&ouml;nnen Sie sich anmelden und mit der Eingabe neuer Themen beginnen.</p>');
...
define('_ITEMLIST_ADDNEW',			'Neues Thema Hinzuf&uuml;gen');
...
define('_MEMBERMAIL_MAIL',			'Deine eMail-Adresse:');

// file upload
define('_ERROR_DISALLOWEDUPLOAD2',	'Du hast keine Administratorrechte auf den Blogs, welche diese Mitglieder in den Teamlisten haben. Deshalb ist es Dir nicht gestattet, Dateien in das Media-Verzeichnis des Mitgleids hochzuladen.');

// plugin list
define('_LISTS_INFO',				'Information');
define('_LIST_PLUGS_AUTHOR',		'Von:');
define('_LIST_PLUGS_VER',			'Version:');
define('_LIST_PLUGS_SITE',			'Site besuchen');
...
// plugin options
define('_ERROR_NOPLUGOPTIONS',		'Dieses Plugin hat keine Optionen gesetzt');
define('_PLUGS_BACK',				'Zur&uuml;ck zur Plugin-Übersicht');
...
define('_EDIT_SUBMIT',				'Thema freigeben');
...
define('_TEMPLATE_BACK',			'Zur&uunl;ck zur Template-&Uuml;bersicht');
...
define('_TEMPLATE_ITEMFOOTER',		'Themen-Fusszeile');
...
define('_TEMPLATE_CATEGORYLIST',	'Kategiórielisten');
define('_TEMPLATE_CATHEADER',		'Kategorielisten &Uuml;berschriften');
define('_TEMPLATE_CATITEM',			'Kategorielisten Themen');
