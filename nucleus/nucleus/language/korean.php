...
define('_ERROR_MOVETOSELF',			'카테고리를 이동할수 없습니다 (목적블로그와 소스블로그가 같습니다)');
...
// file upload
define('_ERROR_DISALLOWEDUPLOAD2',	'당신은 팀리스트의 해당 회원이 속한 블록의 관리자가 아닙니다. 그러므로 이 멤버의 미디어 디렉토리에 파일을 업로드 할 수 없습니다.');
...
define('_CONFIRMTXT_TEAM2',			' 블록의 팀 목록으로부터 ');
define('_CONFIRMTXT_BLOG',			'다음 블록을 삭제하려합니다: ');
define('_WARNINGTXT_BLOGDEL',		'경고! 블록을 삭제하면 블록에 저장된 모든 글과 코멘트가 삭제됩니다. 정말로 이 모든 내용을 삭제하시겠습니까?<br />그리고, Nucleus가 블록을 삭제하는 동안 아무 것도 누르지 마십시오.');
...
define('_DELETED_BLOG',				'블록을 삭제하였습니다');
...
// errors
define('_ERROR_COMMENT_LONGWORD',	'코멘트의 한 단어는 90자를 넘을 수 없습니다');
...
define('_ERROR_COMMENTS_DISABLED',	'이 블록은 현재 코멘트 기능을 사용하지 않습니다.');
define('_ERROR_COMMENTS_NONPUBLIC',	'이 블록에 코멘트를 달기 위해선 먼저 로그인을 해야합니다');
...
define('_ERROR_NOSUCHBLOG',			'그런 블록이 없습니다');
...
define('_ERROR_BADDESTBLOG',		'이동하려는 블록이 없습니다');
define('_ERROR_NOTONDESTTEAM',		'이동하려는 블록의 팀리스트에 가입되지 않았으므로, 글을 옮길 수 없습니다');
...
define('_ERROR_BADNAME',			'부적절한 이름입니다 ( a-z 또는 0-9 만 사용하실 수 있으며, 처음과 끝에 여백이 없어야 합니다)');
...
define('_ERROR_BADSHORTBLOGNAME',	'짧은 블록 이름에는 공백없이 a-z 또는 0-9 만 사용할 수 있습니다');
...
define('_ERROR_DELDEFBLOG',			'기본설정된 블록은 삭제할 수 없습니다');
...
define('_MSG_NEWBLOG',				'새 블록을 생성하였습니다');
define('_MSG_ACTIONLOGCLEARED',		'작업로그를 비웠습니다');

// actionlog in admin area
define('_ACTIONLOG_DISALLOWED',		'금지된 작업: ');
define('_ACTIONLOG_PWDREMINDERSENT','새로운 암호가 ');
define('_ACTIONLOG_TITLE',			'작업로그');
define('_ACTIONLOG_CLEAR_TITLE',	'작업로그 소거');
define('_ACTIONLOG_CLEAR_TEXT',		'작업로그를 지금 비웁니다');

// team management
define('_TEAM_TITLE',				'다음 블록에 대한 팀 관리 ');
...
// blogsettings
define('_EBLOG_TITLE',				'블록 설정 변경');
define('_EBLOG_TEAM_TITLE',			'팀 변경');
define('_EBLOG_TEAM_TEXT',			'팀을 변경하려면 여기를 클릭하세요.');
define('_EBLOG_SETTINGS_TITLE',		'블록 설정');
define('_EBLOG_NAME',				'블록 이름');
define('_EBLOG_SHORTNAME',			'짧은 블록 이름');
define('_EBLOG_SHORTNAME_EXTRA',	'<br />(여백없이 a-z 만 사용해야합니다)');
define('_EBLOG_DESC',				'블록 설명');
...
define('_OVERVIEW_EDITSETTINGS',	'설정 바꾸기...');
...
// move item
define('_MOVE_TITLE',				'어떤 블록으로 옮길까요?');
define('_MOVE_BTN',					'글 이동');
