...
define('_BATCH_UNKNOWN',			'’γνωστη μαζική λειτουργία: ');
...
define('_TEMPLATE_AITEM',			'’ρθρο λίστας αρχείου');
...
define('_SKIN_PARTS_MSG',			'Δεν χρειάζονται όλοι οι τύποι για κάθε εμφάνιση. ’φησε κενά αυτά που δεν χρειάζονται. Διαλέξτε τον τύπο εμφάνισης που θα επεξεργαστείτε:');
...
// ITEMLIST
define('_ITEMLIST_BLOG',			'’ρθρα για το ιστολόγιο'); 
