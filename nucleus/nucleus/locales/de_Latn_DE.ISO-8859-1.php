...
define('_ADMINPAGEFOOT_DONATE',						'Spenden f�;r Nucleus CMS!');
...
define('_EBLOG_REQUIREDEMAIL',						'E-Mail Addresse f�;r Kommentare voraussetzen?');
define('_BMLET_BACKTODRAFTS',						'Zur�;ck zu den Entw�;rfen verschieben');
...
define('_TEMPLATE_PLUGIN_FIELDS',					'Zus�;tzliche Plugin Felder');
...
define('_ADMIN_SYSTEMOVERVIEW_VERSIONCHECK',		'Pr�;fen ob eine neue Version erh�;ltlich ist');
define('_ADMIN_SYSTEMOVERVIEW_VERSIONCHECK_TXT',	'Pr�;fen, ob eine neue Version erh�;ltlich ist: ');
define('_ADMIN_SYSTEMOVERVIEW_VERSIONCHECK_URL',	'http://nucleuscms.org/version.php?v=%d&amp;pl=%d');
define('_ADMIN_SYSTEMOVERVIEW_VERSIONCHECK_TITLE',	'Pr�;fen ob eine neue Version/Uprgrade erh�;ltlich ist');
define('_ADMIN_SYSTEMOVERVIEW_NOT_ADMIN',			"Sie haben nicht gen�;gend Rechte, um die System informationen einzusehen.");
...
define('_COMMENTS_BLOG',			'Alle Kommentare f�;r das Blog');
...
define('_ERROR_BADTICKET',			'Ung�;ltiges oder erloschenes Ticket.');

// plugin dependency
define('_ERROR_INSREQPLUGIN',		'Plugin-Installation misslungen, erfordert ');
define('_ERROR_DELREQPLUGIN',		'L�;schen des Plugins misslungen, ben�;tigt von ');

// cookie prefix
define('_SETTINGS_COOKIEPREFIX',	'Cookie-Pr�;fix');

// account activation
define('_ERROR_NOLOGON_NOACTIVATE',	'Kann Aktivierungslink nicht senden. Erlaubnis zum Login verweigert.');
define('_ERROR_ACTIVATE',			'Aktivierungsschl�;ssel nicht vorhanden, ung�;ltig oder abgelaufen.');
define('_ACTIONLOG_ACTIVATIONLINK', 'Aktivierungslink gesendet');
define('_MSG_ACTIVATION_SENT',		'Ein Aktivierungslink wurde per eMail �;bermittelt.');

// activation link emails
define('_ACTIVATE_REGISTER_MAIL',	"Hi <%memberName%>,\n\nSie m�;ssen Ihren Konto auf <%siteName%> (<%siteUrl%>) aktivieren.\nSie k�;nnen dies durch Klick auf den nachstehenden Link erledigen: \n\n\t<%activationUrl%>\n\nSie haben daf�;r zwei Tage. Danach wird dieser Aktivierungslink ung�;ltig.");
...
define('_ACTIVATE_REGISTER_TEXT',	'Sie sind fast fertig. Bitte w�;hlen Sie ein Passwort f�;r den nachstehenden Konto.');
define('_ACTIVATE_FORGOT_MAIL',		"Hi <%memberName%>,\n\nMit dem nachstehenden Link k�;nnen Sie ein neues Passwort f�;r Ihren Konto auf <%siteName%> (<%siteUrl%>) bestimmen.\n\n\t<%activationUrl%>\n\nSie haben daf�;r zwei Tage. Danach wird dieser Aktivierungslink ung�;ltig.");
...
define('_ACTIVATE_FORGOT_TEXT',		'Sie k�;nnen f�;r den nachstehenden Konto ein neues Passwort bestimmen:');
define('_ACTIVATE_CHANGE_MAIL',		"Hallo <%memberName%>,\n\nDa Ihre eMail-Adresse ge�;ndert wurde, m�;ssen Sie Ihren Konto bei <%siteName%> (<%siteUrl%>) neu aktivieren.\nSie k�;nnen dies durch Klick auf den nachstehenden Link erledigen: \n\n\t<%activationUrl%>\n\nSie haben daf�;r zwei Tage. Danach wird dieser Aktivierungslink ung�;ltig.");
...
define('_ACTIVATE_CHANGE_TEXT',		'Ihre Adress�;nderung wurde �;berpr�;ft. Vielen Dank!');
...
define('_QMENU_ACTIVATE_TEXT',		'<p>Nachdem Sie Ihr Konto aktiviert haben, k�;nnen Sie sich <a href="index.php?action=showlogin">anmelden</a>.</p>');

define('_PLUGS_BTN_UPDATE',			'Abonnementliste aktualisieren');

// global settings
define('_SETTINGS_JSTOOLBAR',		'Javascript Werkzeugleisten-Stil');
define('_SETTINGS_JSTOOLBAR_FULL',	'Vollst�;ndige Werkzeugleiste (IE)');
...
define('_PLUGINS_EXTRA',			'Zus�;tzliche Plugin Einstellungen');
...
// batch operations
define('_BATCH_WITH_SEL',			'Mit ausgew�;hlten:');
define('_BATCH_EXEC',				'Ausf�;hren');

// quickmenu
define('_QMENU_HOME',				'Home');
define('_QMENU_ADD',				'Neuer Artikel');
define('_QMENU_ADD_SELECT',			'-- ausw�;hlen --');
...
define('_QMENU_INTRO',				'Einf�;hrung');
define('_QMENU_INTRO_TEXT',			'<p>Dies ist die Login-Seite f�;r das Nucleus CMS, dem Content Management-System zur Verwaltung dieser Website.</p><p>Wenn Sie ein Benutzerkonto besitzen, k�;nnen Sie sich anmelden und mit der Eingabe neuer Artikel beginnen.</p>');

// helppages for plugins
define('_ERROR_PLUGNOHELPFILE',		'Die Hilfedatei f�;r dieses Plugin wurde nicht gefunden');
define('_PLUGS_HELP_TITLE',			'Hilfe f�; das Plugin');
...
define('_MEDIA_VIEW_TT',			'Datei anzeigen (�;ffnet sich in einem neuen Fenster)');
...
// tooltips on toolbar
define('_ADD_ALIGNLEFT_TT',			'Linksb�;ndig ausrichten');
define('_ADD_ALIGNRIGHT_TT',		'Rechtsb�;ndig ausrichten');
...
define('_ADD_CHANGEDATE',			'Zeitstempel �;ndern');
define('_BMLET_CHANGEDATE',			'Zeitstempel �;ndern');
...
// Batch operations
define('_BATCH_NOSELECTION',		'Kein Ziel f�;r die Aktion ausgew�;hlt');
define('_BATCH_ITEMS',				'Stapelaktionen f�;r Beitr�;ge');
define('_BATCH_CATEGORIES',			'Stapelaktionen f�;r Kategorien');
define('_BATCH_MEMBERS',			'Stapeloperationen f�;r Mitglieder');
define('_BATCH_TEAM',				'Stapeloperationen f�;r Teammitglieder');
define('_BATCH_COMMENTS',			'Stapeloperationen f�;r Kommentare');
define('_BATCH_UNKNOWN',			'Unbekannte Stapeloperation: ');
define('_BATCH_EXECUTING',			'Wird ausgef�;hrt:');
...
define('_BATCH_DELETE_CONFIRM',		'L�;schen im Batchbetrieb best�;tigen');
define('_BATCH_DELETE_CONFIRM_BTN',	'L�;schen best�;tigen');
define('_BATCH_SELECTALL',			'Alle ausw�;hlen');
define('_BATCH_DESELECTALL',		'Alle abw�;hlen');

// batch operations: options in dropdowns
define('_BATCH_ITEM_DELETE',		'L�;schen');
define('_BATCH_ITEM_MOVE',			'Verschieben');
define('_BATCH_MEMBER_DELETE',		'L�;schen');
define('_BATCH_MEMBER_SET_ADM',		'Administratorrechte geben');
define('_BATCH_MEMBER_UNSET_ADM',	'Administratorrechte nehmen');
define('_BATCH_TEAM_DELETE',		'Aus Team l�;schen');
define('_BATCH_TEAM_SET_ADM',		'Administratorrechte geben');
define('_BATCH_TEAM_UNSET_ADM',		'Administratorrechte nehmen');
define('_BATCH_CAT_DELETE',			'L�;schen');
define('_BATCH_CAT_MOVE',			'In anderes Blog verschieben');
define('_BATCH_COMMENT_DELETE',		'L�;schen');

// itemlist: Add new item...
define('_ITEMLIST_ADDNEW',			'Neuen Artikel Hinzuf�;gen');
define('_ADD_PLUGIN_EXTRAS',		'Zus�;tzliche Plugin Optionen');
...
// backlinks
define('_BACK_TO_BLOGSETTINGS',		'Zur�;ck zu den Blog Einstellungen');

// skin import export
define('_SKINIE_TITLE_IMPORT',		'Importieren');
define('_SKINIE_TITLE_EXPORT',		'Exportieren');
define('_SKINIE_BTN_IMPORT',		'Importieren');
define('_SKINIE_BTN_EXPORT',		'Exportieren der ausgew�;hlten Designvorlagen/Templates');
...
define('_SKINIE_EXPORT_INTRO',		'Unten ausw�;hlen, was exportiert werden soll');
...
define('_SKINIE_CONFIRM_OVERWRITE',	'Bestehende Designvorlagen �;berschreiben (siehe unten)');
...
define('_LIST_SKINS_INCPREFIX',		'Include-Pr�;fix:');
...
define('_RESTORE_NOTE',				'<b>WARNUNG:</b> Wiederherstellen wird alle bestehenden Daten <b>L�;SCHEN</b>!<br />	<b>Achtung:</b> Die Version von Sicherungskopie und Laufzeitsystem muss �;bereinstimmen, ansonsten wird es nicht funktionieren!');
define('_RESTORE_INTRO',			'Sicherungsdatei ausw�;hlen, danach startet das Wiederherstellen.');
...
define('_NOTIFY_TITLE',				'�;berschrift:');
...
// bookmarklet buttons
define('_BMLET_ADD',				'Hinzuf�;gen');
define('_BMLET_EDIT',				'Bearbeiten');
define('_BMLET_DELETE',				'L�;schen');
define('_BMLET_BODY',				'Einf�;hrung');
...
define('_ITEM_DELETED',				'Bookmarklet wurde gel�;scht');

// plugins
define('_CONFIRMTXT_PLUGIN',		'Plugin wirklich l�;schen');
...
define('_PLUGS_ADD_TEXT',			'Unten steht eine Liste von m�;glichen, nicht installierten Plugins. Bitte <strong>vor dem Installieren sicherstellen</strong>, dass es tatschlich ein Plugin ist.');
define('_PLUGS_BTN_INSTALL',		'Plugin installieren');
define('_BACKTOOVERVIEW',			'Zur�;ck zur �bersicht');

// editlink
define('_TEMPLATE_EDITLINK',		'Link bearbeiten');

// add left / add right tooltips
define('_ADD_LEFT_TT',				'Linke Box hinzuf�;gen');
define('_ADD_RIGHT_TT',				'Rechte Box hinzuf�;gen');
...
define('_SETTINGS_MAXUPLOADSIZE',	'Max. Upload-Dateigr�;�e (Bytes)');
define('_SETTINGS_NONMEMBERMSGS',	'Erlaube Nicht-Mitgliedern das Senden von Nachrichten');
define('_SETTINGS_PROTECTMEMNAMES',	'Mitgliedernamen sch�;tzen');
...
define('_LIST_PLUGS_SUBS',			'Folgende Ereignisse �;bermitteln:');
...
define('_PLUGS_BACK',				'Zur�;ck zur Plugin �;bersicht');
...
define('_BACKTOMANAGE',				'Zur�;ck zur Nucleus Verwaltung');
...
define('_NAME',						'Name');
define('_BACKHOME',					'Zur�;ck zur Admin Startseite');
...
define('_POPUP_CLOSE',				'Fenster schlie�en');
define('_LOGIN_PLEASE',				'Bitte zuerst anmelden');

// commentform
define('_COMMENTFORM_YOUARE',		'Sie sind');
define('_COMMENTFORM_SUBMIT',		'Kommentar hinzuf�;gen');
...
define('_ADD_ADDTO',				'Neuen Artikel hinzuf�;gen zu');
...
define('_ADD_ADDITEM',				'Artikel hinzuf�;gen');
define('_ADD_ADDNOW',				'Jetzt hinzuf�;gen');
define('_ADD_ADDLATER',				'Sp�;ter hinzuf�;gen');
define('_ADD_PLACE_ON',				'am');
define('_ADD_ADDDRAFT',				'Zu Entw�;rfen hinzuf�;gen');
define('_ADD_DRAFTNFUTURE',			'Entw�;rfe &amp; zuk�;nftige Inhalte');
define('_ADD_NOPASTDATES',			'(Datum und Zeiten aus der Vergangenheit sind ung�;ltig, wird durch aktuelles Datum ersetzt)');
define('_ADD_BOLD_TT',				'Fett');
define('_ADD_ITALIC_TT',			'Kursiv');
define('_ADD_HREF_TT',				'Link erstellen');
define('_ADD_MEDIA_TT',				'Bild hinzuf�;gen');
define('_ADD_PREVIEW_TT',			'Zeige/Verberge Vorschau');
define('_ADD_CUT_TT',				'L�;schen');
define('_ADD_COPY_TT',				'Kopieren');
define('_ADD_PASTE_TT',				'Einf�;gen');

// edit item form
define('_EDIT_ITEM',				'Artikel bearbeiten');
define('_EDIT_SUBMIT',				'Artikel freigeben');
define('_EDIT_ORIG_AUTHOR',			'Autor - Urheber');
define('_EDIT_BACKTODRAFTS',		'Entwurf um Hintergrund erg�;nzen');
define('_EDIT_COMMENTSNOTE',		'(Achtung: Beim Ausschalten der Kommentarfunktion bleiben bisherige Kommentare online)');

// used on delete screens
define('_CONFIRMTXT_CATEGORY',		'Sie sind dabei, folgende Kategorie zu l�;schen: ');
define('_DELETE_CONFIRM',			'Bitte L�;schen best�;tigen');
define('_DELETE_CONFIRM_BTN',		'L�;schen best�;tigen');
define('_CONFIRMTXT_ITEM',			'Sie sind dabei, folgenden Artikel zu l�;schen:');
define('_CONFIRMTXT_COMMENT',		'Sie sind dabei, den folgenden Kommentar zu l�;schen:');
define('_CONFIRMTXT_TEAM1',			'Sie sind dabei ');
define('_CONFIRMTXT_TEAM2',			' aus der Teamliste oder dem Blog zu l�;schen ');
define('_CONFIRMTXT_BLOG',			'Folgendes Weblog soll gel�;scht werden: ');
define('_WARNINGTXT_BLOGDEL',		'Achtung! Beim L�;schung des Weblogs werden alle Artikel und Kommentare mitgel�;scht. Bitte best�;tigen Sie diese Aktion noch einmal!<br />Bitte Nukleus w�;hrend des L�;schvorgangs nicht unterbrechen.');
define('_CONFIRMTXT_MEMBER',		'Sie sind dabei, folgendes Mitglied zu l�;schen: ');
define('_CONFIRMTXT_TEMPLATE',		'Sie sind dabei, folgendes Template zu l�;schen ');
define('_CONFIRMTXT_SKIN',			'Sie sind dabei, folgende Designvorlage zu l�;schen ');
define('_CONFIRMTXT_BAN',			'Sie sind dabei, folgende blockierte IP-Adressen freizugeben');

// some status messages
define('_DELETED_CATEGORY',			'Kategorie gel�;scht');
define('_SKIN_UPDATED',				'Designvorlage wurde gespeichert');
define('_TEMPLATE_UPDATED',			'Template Daten wurden gespeichert');
define('_DELETED_ITEM',				'Artikel gel�;scht');
define('_DELETED_MEMBER',			'Mitglied gel�;scht');
define('_DELETED_COMMENT',			'Kommentar gel�;scht');
define('_DELETED_BLOG',				'Blog gel�;scht');
define('_ITEM_MOVED',				'Artikel verschoben');
define('_ITEM_ADDED',				'Artikel hinzugef�;gt');
define('_COMMENT_UPDATED',			'Kommentar ge�;ndert');
...
define('_ERROR_COMMENT_NOUSERNAME',	'Username nicht zul�;ssig');
define('_ERROR_COMMENT_TOOLONG',	'Ihr Kommentar ist zu lang (max. 5.000 Zeichen)');
define('_ERROR_COMMENTS_DISABLED',	'Kommentare sind in diesem Bereich momentan nicht m�;glich.');
define('_ERROR_COMMENTS_NONPUBLIC',	'Kommentare k�;nnen hier nur von Mitgliedern abgegeben werden');
define('_ERROR_COMMENTS_MEMBERNICK','Dieser Benutzername ist bereits vergeben. Bitte einen neuen ausw�;hlen.');
define('_ERROR_SKIN',				'Fehler in der Designvorlage');
define('_ERROR_ITEMCLOSED',			'Dieser Diskussionspunkt ist geschlossen. Es k�;nnen keine Kommentare vergeben werden.');
...
define('_ERROR_NOTONTEAM',			'Sie stehen nicht in der Teamliste f�;r dieses Weblog.');
...
define('_ERROR_NOEMPTYITEMS',		'Leerer Artikel kann nicht hinzugef�;gt werden');
define('_ERROR_BADMAILADDRESS',		'Keine g�;ltige E-Mail-Adresse');
define('_ERROR_BADNOTIFY',			'Eine oder mehrere der angegebenen E-Mail-Adressen ist ung�;ltig');
define('_ERROR_BADNAME',			'Benutzername ung�;ltig (nur a-z und 0-9 gestattet, keine Leerzeichen am Beginn und am Ende)');

define('_ERROR_NICKNAMEINUSE',		'Dieser Spitzname wird von einem anderen Mitglied benutzt');
define('_ERROR_PASSWORDMISMATCH',	'Die Passw�;rter m�;sen �;bereinstimmen');
...
define('_ERROR_REALNAMEMISSING',	'Sie m�;ssen einen echten Namen angeben');
define('_ERROR_ATLEASTONEADMIN',	'Es muss immer ein Super-Administrator vorhanden sein.');
define('_ERROR_ATLEASTONEBLOGADMIN','Wenn Sie dies tun, ist Ihr Weblog nicht mehr bearbeitbar. Sie m�;ssen mindestens einen Administrator bestimmen.');
define('_ERROR_ALREADYONTEAM',		'Mitglied schon vorhanden, kann nicht hinzugef�;gt werden');
define('_ERROR_BADSHORTBLOGNAME',	'Der Kurzname f�;r das Weblog kann nur a-z and 0-9 enthalten, ohne Leerzeichen');
define('_ERROR_DUPSHORTBLOGNAME',	'Dieser Kurzname f�;r ein Weblog ist bereits vergeben');
define('_ERROR_UPDATEFILE',			'Habe keine Schreibrechte f�;r die Update-Datei. Bitte Rechte korrekt einstellen (chmod 666). Bitte ber�;cksichtigen, dass der Speicherplatz relativ zum Admin-Verzeichnis liegt, eventuell also absoluten Pfad angeben (z.B. /home/www/site10/web/nucleus/)');
define('_ERROR_DELDEFBLOG',			'Standard Weblog kann nicht gel�;scht werden');
define('_ERROR_DELETEMEMBER',		'Dieses Mitglied kann nicht gel�;scht werden. Vermutlich ist es als Autor gef�;hrt');
define('_ERROR_BADTEMPLATENAME',	'Ung�;ltiger Template Name, nur a-z und 0-9 verwenden, ohne Leerzeichen');
define('_ERROR_DUPTEMPLATENAME',	'Ein Template mit diesem Namen ist bereits vorhanden');
define('_ERROR_BADSKINNAME',		'Ung�;ltiger Name f�;r Designvorlage (nur a-z, 0-9 erlaubt, keine Leerzeichen)');
...
define('_ERROR_SKINDEFDELETE',		'Designvorlage \'default\' kann nicht gel�;scht werden f�;r das folgende Weblog: ');
define('_ERROR_DISALLOWED',			'Sie sind zu dieser Aktion nicht berechtigt');
define('_ERROR_DELETEBAN',			'Fehler beim l�;schen des IP-Ban (existiert nicht)');
define('_ERROR_ADDBAN',				'Fehler beim hinzuf�;gen des IP-Ban. M�;glicherweise nicht in allen Weblogs korrekt hinzugef�;gt.');

define('_ERROR_BADACTION',			'Diese Aktion ist nicht m�;glich');
...
define('_ERROR_BANNED1',			'Aktion nicht durchf�;hrbar, weil Sie (IP-Bereich ');
define('_ERROR_BANNED2',			') hierf�;r gesperrt sind. Ihre Nachricht: \'');
define('_ERROR_BANNED3',			'\'');
define('_ERROR_LOGINNEEDED',		'F�;r diese Aktion m�;ssen Sie angemeldet sein');
...
define('_ERROR_DISALLOWEDUPLOAD',	'Sie sind kein Teammitglied. Deshalb d�;rfen Sie keine Dateien hochladen');
define('_ERROR_BADPERMISSIONS',		'Zugriffsrechte f�;r Datei oder Verzeichnis falsch eingestellt');
...
define('_ERROR_LOGINDISALLOWED',	'Sie sind f�;r den Administrationsbereich nicht freigeschaltet. Sie k�;nnen sich als Benutzer anmelden.');
...
define('_ERROR_DELETEDEFCATEGORY',	'Standard Kategorie kann nicht gel�;scht werden');
define('_ERROR_BADCATEGORYNAME',	'Ung�;ltiger Kategoriename');
...
define('_MEDIA_MODIFIED',			'ge�;ndert');
...
define('_UPLOAD_TITLE',				'Datei ausw�;hlen');
define('_UPLOAD_MSG',				'Datei, die Sie hochladen m�;chten, ausw�;hlen, und Hochladen-Taste klicken.');
...
define('_MSG_LOGINAGAIN',			'Sie m�;ssen sich neu anmelden, da sich Ihre Benutzerdaten ge�;ndert haben');
define('_MSG_SETTINGSCHANGED',		'Einstellungen ge�;ndert');
define('_MSG_ADMINCHANGED',			'Administrator ge�;ndert');
define('_MSG_NEWBLOG',				'Neues Weblog angelegt');
define('_MSG_ACTIONLOGCLEARED',		'Logdatei gel�;scht');
...
define('_ACTIONLOG_CLEAR_TITLE',	'Logdatei l�;schen');
define('_ACTIONLOG_CLEAR_TEXT',		'Logdatei jetzt l�;schen');

// team management
define('_TEAM_TITLE',				'Team verwalten f�;r Blog ');
define('_TEAM_CURRENT',				'Derzeitiges Team');
define('_TEAM_ADDNEW',				'Neues Teammitglied hinzuf�;gen');
define('_TEAM_CHOOSEMEMBER',		'Teammitglied ausw�;hlen');
define('_TEAM_ADMIN',				'Administratorrechte? ');
define('_TEAM_ADD',					'Zum Team hinzuf�;gen');
define('_TEAM_ADD_BTN',				'Zum Team hinzuf�;gen');
...
define('_EBLOG_LINEBREAKS',			'Zeilenumbr�;che automatisch konvertieren');
define('_EBLOG_DISABLECOMMENTS',	'Kommentare erlauben?<br /><small>(Wenn nicht erlaubt, sind Kommentare unm�;glich.)</small>');
...
define('_EBLOG_PING',				'Weblogs.com bei �;nderungen anpingen?');
...
define('_EBLOG_CHANGE',				'�;ndern');
define('_EBLOG_CHANGE_BTN',			'�;ndern');
...
define('_EBLOG_CREATE_TEXT',		'Formular ausf�;llen, um ein neues Weblog zu erstellen. <br /><br /> <b>Achtung:</b> Nur die notwendigsten Einstellungen sind hier aufgef�;hrt. Weitere Einstellungen lassen sich anschliessend �;ber die Weblog-Einstellungen vornehmen.');
define('_EBLOG_CREATE',				'Erstellen!');
define('_EBLOG_CREATE_BTN',			'Weblog erstellen');

// templates
define('_TEMPLATE_TITLE',			'Templates bearbeiten');
define('_TEMPLATE_AVAILABLE_TITLE',	'Verf�;gbare Templates');
...
define('_TEMPLATE_BACK',			'Zur�;ck zur Template �;bersicht');
define('_TEMPLATE_EDIT_MSG',		'Nicht alle Teile des Templates werden gebraucht, bitte nicht ben�;tigte einfach leer lassen.');
...
define('_TEMPLATE_AHEADER',			'Archivliste �;berschriften');
...
define('_TEMPLATE_RESET_BTN',		'Zur�;cksetzen');
define('_TEMPLATE_CATEGORYLIST',	'Kategorielisten');
define('_TEMPLATE_CATHEADER',		'Kategorielisten �;berschriften');
...
define('_SKIN_AVAILABLE_TITLE',		'Verf�;gbare Designvorlagen');
...
define('_SKIN_BACK',				'Zur�;ck zum �;berblick Designvorlagen');
define('_SKIN_PARTS_TITLE',			'Designvorlagen-Teile');
define('_SKIN_PARTS_MSG',			'Nicht alle Teile werden f�;r Designvorlagen ben�;tigt. Nicht ben�;tigte Teile leer lassen. Designvorlage zum Bearbeiten ausw�;hlen:');
...
define('_SKIN_CHANGE',				'�;ndern');
define('_SKIN_CHANGE_BTN',			'Diese Einstellungen �;ndern');
define('_SKIN_UPDATE_BTN',			'Designvorlage neu speichern');
define('_SKIN_RESET_BTN',			'Zur�;cksetzen');
define('_SKIN_EDITPART_TITLE',		'Designvorlage bearbeiten');
define('_SKIN_GOBACK',				'Zur�;ck');
define('_SKIN_ALLOWEDVARS',			'G�;ltige Variablen (klicken f�;r mehr Infos):');
...
define('_SETTINGS_ALLOWUPLOADTYPES','G�;ltige Dateitypen f�;r den Upload');
define('_SETTINGS_CHANGELOGIN',		'Benutzer d�;rfen Name/Passwort �;ndern');
define('_SETTINGS_COOKIELIFE',		'Lebensdauer Cookie f�;r Benutzer');
...
define('_SETTINGS_NEWLOGIN2',		'(gilt nur f�;r neue Benutzer-Konten)');
...
// bans
define('_BAN_TITLE',				'Zugriff verweigern f�;r');
define('_BAN_NONE',					'Keine Zugriffsperren f�;r dieses Weblog');
define('_BAN_NEW_TITLE',			'Neue Zugriffssperre erstellen');
define('_BAN_NEW_TEXT',				'Neue Zugriffssperre hinzuf�;gen');
define('_BAN_REMOVE_TITLE',			'Zugriffssperre l�;schen');
define('_BAN_IPRANGE',				'IP-Bereich');
define('_BAN_BLOGS',				'Welche Weblogs?');
define('_BAN_DELETE_TITLE',			'Zugriffssperre l�;schen');
define('_BAN_ALLBLOGS',				'Alle Zugriffssperren in Ihrem Admin-Bereich.');
define('_BAN_REMOVED_TITLE',		'Zugriffssperre gel�;scht');
define('_BAN_REMOVED_TEXT',			'Zugriffssperre in folgenden Weblogs gel�;scht:');
define('_BAN_ADD_TITLE',			'Zugriffssperre hinzuf�;gen');
define('_BAN_IPRANGE_TEXT',			'Zu sperrenden IP-Bereich ausw�;hlen. Je weniger Nummern, desto mehr Benutzer werden blockiert.');
define('_BAN_BLOGS_TEXT',			'Sie k�;nnen wahlweise nur ein Weblog sperren oder alle Punkte in Ihrem Admin-Bereich. Bitte ausw�;hlen.');
define('_BAN_REASON_TITLE',			'Grund');
define('_BAN_REASON_TEXT',			'Sie k�;nnen die Zugriffssperre begr�;nden, dies wird dem Benutzer angezeigt. Maximal 256 Zeichen.');
define('_BAN_ADD_BTN',				'Zugriffssperre hinzuf�;gen');
...
define('_MEMBERS_EMAIL_EDIT',		'(Beim �;ndern der eMail-Adresse erhalten Sie umgehend ein neues Passwort per Mail)');
...
define('_MEMBERS_NEW_BTN',			'Benutzer hinzuf�;gen');
define('_MEMBERS_EDIT',				'Benutzer bearbeiten');
define('_MEMBERS_EDIT_BTN',			'Einstellungen �;ndern');
define('_MEMBERS_BACKTOOVERVIEW',	'Zur�;ck zur Benutzerverwaltung');

// List of blogs (TT = tooltip)
define('_BLOGLIST_TT_EDIT',			'');
define('_BLOGLIST_BMLET',			'Bookmarklet');
define('_BLOGLIST_TT_BMLET',		'');
define('_BLOGLIST_TT_VISIT',		'Webseite ausw�;hlen');
define('_BLOGLIST_ADD',				'Artikel hinzuf�;gen');
define('_BLOGLIST_TT_ADD',			'Neuen Artikel zu diesem Weblog hinzuf�;gen');
define('_BLOGLIST_EDIT',			'Artikel bearbeiten oder l�;schen');
define('_BLOGLIST_BMLET',			'Favoritenverwaltung');
define('_BLOGLIST_SETTINGS',		'Einstellungen');
define('_BLOGLIST_TT_SETTINGS',		'Einstellungen �;ndern oder Team verwalten');
define('_BLOGLIST_BANS',			'Zugriffssperren');
define('_BLOGLIST_TT_BANS',			'Zugriffssperren verwalten');
define('_BLOGLIST_DELETE',			'Alles l�;schen');
define('_BLOGLIST_TT_DELETE',		'L�;sche dieses Weblog');

// OVERVIEW screen
define('_OVERVIEW_YRBLOGS',			'Ihre Weblogs');
define('_OVERVIEW_YRDRAFTS',		'Ihre Entw�;rfe');
define('_OVERVIEW_YRSETTINGS',		'Ihre Einstellungen');
define('_OVERVIEW_GSETTINGS',		'Allgemeine Einstellungen');
define('_OVERVIEW_NOBLOGS',			'Sie sind nicht als Benutzer aufgef�;hrt');
define('_OVERVIEW_NODRAFTS',		'Keine Entw�;rfe');
...
define('_LIST_ITEM_CONTENT',		'�;berschrift und Text');


// teamlist
define('_LIST_TEAM_ADMIN',			'Administrator ');
define('_LIST_TEAM_CHADMIN',		'Administrator �;ndern');
