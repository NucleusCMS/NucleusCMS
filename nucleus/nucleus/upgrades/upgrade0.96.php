...
$query = "CREATE TABLE nucleus_actionlog (timestamp datetime NOT NULL default '0000-00-00 00:00:00', message varchar(255) NOT NULL default '', PRIMARY KEY  (timestamp)) TYPE=MyISAM;";
upgrade_query("Creating nucleus_actionlog table",$query);

// 2. create nucleus_ban
$query = "CREATE TABLE nucleus_ban (  iprange varchar(15) NOT NULL default '',  reason varchar(255) NOT NULL default '',  blogid int(11) NOT NULL default '0') TYPE=MyISAM;";
...
$query = "CREATE TABLE nucleus_karma ("
...
$query = "INSERT INTO nucleus_config VALUES ('MediaURL', '$mediaURL');";
$query2 = "INSERT INTO nucleus_config VALUES ('AllowedTypes', 'jpg,jpeg,gif,mpg,mpeg,avi,mov,mp3,swf,png');";
$query3 = "INSERT INTO nucleus_config VALUES ('AllowLoginEdit', '0');";
$query4 = "INSERT INTO nucleus_config VALUES ('AllowUpload', '1');";
...
$query = "SELECT sdnumber FROM nucleus_skin_desc WHERE sdname='default'";
$res = sql_query($query);
$obj = mysql_fetch_object($res);
$skinid = $obj->sdnumber;
$query = "INSERT INTO nucleus_skin VALUES (" . $skinid . ", 'imagepopup', '<html>\r\n<head>\r\n  <title><%imagetext%></title>\r\n  <style type=\"text/css\">\r\n   img { border: none; }\r\n  </style>\r\n</head>\r\n<body>\r\n  <a href=\"javascript:window.close();\"><%image%></a>\r\n</body>\r\n</html>');";
...
while ($obj = mysql_fetch_object($res)) {
	...
	$query = "INSERT INTO nucleus_template VALUES ($tid, 'POPUP_CODE', '<%popuplink%>');";
	$query2 = "INSERT INTO nucleus_template VALUES ($tid, 'MEDIA_CODE', '<%media%>');";
	$query3 = "INSERT INTO nucleus_template VALUES ($tid, 'IMAGE_CODE', '<%image%>');";
